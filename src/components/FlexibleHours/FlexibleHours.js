...
const FlexibleHours = () => {
	...
	return (
		<div className="job-detail-container">
			...
			<p>
				Hey, some people are morning people and some people aren’t, so we don’t
				really care when you start your day… but you need to be able to
			...
			<p>
				We’re all “Computer Employees” exempt from overtime pay, but our goal is
				to never have to ask you to work over 40 hours. We know continually
			...
			<p>
				...
				lot of us don’t. That said, we generally have new hires come to Spokane
				for about a week to meet the local team. We like to think that we’re
				smarter when we work together. Collaboration and teamwork are key to how
				we work at Two Barrels.
			</p>
		</div>
	);
};
