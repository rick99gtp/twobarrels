		...
		<div className="outer-container">
			<div className="job-detail-container">
				...
				<p>
					...
					employees qualify for a WFH quarterly allowance. Think of this
					allowance as a way to upgrade your internet, pay for downtown parking,
					or to buy yourself a fancy espresso machine. You do you.
				</p>
			</div>
		</div>
	);
